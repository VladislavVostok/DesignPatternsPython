...
class Proxy(Subject):
    ...
    def check_access(self) -> bool:
        print("Proxy: Проверка доступа перед отправкой реального запроса.")
        return True

    def log_access(self) -> None:
        print("Proxy: Регистрация времени запроса.", end="")
...
if __name__ == "__main__":
    print("Client: Выполнение клиентского кода с реальным субъектом:")
    real_subject = RealSubject()
    client_code(real_subject)

    print("")

    print("Client: Выполнение того же клиентского кода через прокси:")
