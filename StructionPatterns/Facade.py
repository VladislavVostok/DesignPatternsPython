...
class Facade:
    ...
    def operation(self) -> str:
        ...
        results = []
        results.append("Фазад инициализирует систему:")
        results.append(self._subsystem1.operation1())
        results.append(self._subsystem2.operation1())
        results.append("Фасад приказывает подсистемам выполнить действие:")
...
class Subsystem2:
    ...
    def operation1(self) -> str:
        return "Subsystem2: Приготовиться!"

    # ...

    def operation_z(self) -> str:
        return "Subsystem2: Пли!"
