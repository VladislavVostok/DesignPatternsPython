...
class Creator(ABC):
    ...
    def some_operation(self) -> str:
        ...
        result = f"Creator: Код того же создателя только что работал с {product.operation()}"
...
def client_code(creator: Creator) -> None:
    ...
    print(f"Client: Я не знаю о классе creator, но он все еще работает.\n"
          f"{creator.some_operation()}", end="")


if __name__ == "__main__":
    print("App: Запущенный с помощью ConcreteCreator1.")
    client_code(ConcreteCreator1())
    print("\n")

    print("App: Запущенный с помощью ConcreteCreator2.")
