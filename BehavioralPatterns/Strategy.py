...
class Context():
    ...
    def do_some_business_logic(self) -> None:
        ...
        print("Context: Сортировка данных с помощью стратегии (не знаю, как она это сделает)")
...
if __name__ == "__main__":
    ...
    print("Client: Стратегия настроена на обычную сортировку.")
    context.do_some_business_logic()
    print()

    print("Client: Стратегия настроена на обратную сортировку.")
