...
class Invoker:
    ...
    def do_something_important(self) -> None:
        ...
        print("Invoker: ... делать что-то действительно важное...")
...
if __name__ == "__main__":
    ...
    invoker = Invoker()
    invoker.set_on_start(SimpleCommand("Сказать Шалом!"))
    receiver = Receiver()
    invoker.set_on_finish(ComplexCommand(receiver, "Отправить Email", "Сохранить отчёт"))
